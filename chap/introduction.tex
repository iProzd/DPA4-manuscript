...
\WH{item 1 is not our contribution. should be entirely reframed.
  novel architecture design: (1) sparse edge equivariant irreps, enable edge-node equivariant product, high capacity. (2) multi-focus, lower cost higher capacity. (3) attention. (4) Lebedev SO(2) FFN.
}
\begin{enumerate}
