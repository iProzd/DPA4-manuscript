...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}
                L{3.35cm}C{1.58cm}C{1.58cm}C{1.58cm}C{1.58cm}C{1.58cm}C{1.58cm}C{1.58cm}@{}}
            \toprule
            \textbf{Hyperparameter} & \makecell{\textbf{Cumulative}\\\textbf{ablation}} & \makecell{\textbf{Compile/}\\\textbf{precision}} & \textbf{Attention} & \makecell{\textbf{Multi-focus}\\\textbf{SO(2)}} & \makecell{\textbf{Edge--node}\\\textbf{degree}\\\textbf{coupling}} & \makecell{\textbf{Sph. grid/}\\\textbf{quad.}} & \textbf{WBN} \\
            \midrule
...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}
                L{3.15cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}@{}}
            \toprule
            \textbf{Hyperparameter} & \textbf{Layers} & \makecell{\textbf{SO(2)}\\\textbf{stack}} & \makecell{\textbf{FFN}\\\textbf{stack}} & \textbf{Attention} & \makecell{\textbf{Norm.}\\\textbf{placement}} & \makecell{\textbf{LR}\\\textbf{scheduler}} \\
            \midrule
            ...
            Modulation rank & N/A & 1 & 1 & N/A & N/A & 1 \\
            \midrule
            Attn. heads & 1 & 1 & 1 & -- & 1 & 1 \\
            ...
            Warmup ratio & 0.003 & 0.003 & 0.003 & 0.003 & 0.003 & 0.003 \\
...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}
                L{4.2cm}C{1.8cm}C{1.8cm}C{1.8cm}C{1.8cm}C{1.8cm}@{}}
            \toprule
...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}
                L{3.6cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}@{}}
            \toprule
            \textbf{Hyperparameter} & \textbf{DPA4-Mini} & \textbf{DPA4-Neo} & \textbf{DPA4-Air} & \textbf{DPA4-Plus} & \textbf{DPA4-Pro} \\
            \midrule
            LR scheduler & WSD & WSD & WSD & WSD & WSD \\
            Max. LR & $2\times10^{-3}$ & $7\times10^{-4}$ & $4.2\times10^{-4}$ & $4.7\times10^{-4}$ & $4.3\times10^{-4}$ \\
            ...
            Batch size (per GPU)\tnote{a} & $\lceil 7000/N\rceil$ & $\lceil 3000/N\rceil$ & $\lceil 1800/N\rceil$ & $\lceil 1500/N\rceil$ & $\lceil 300/N\rceil$ \\
            Training epochs & 150 & 100 & 100 & 100 & 140 \\
            No. GPUs & 1 & 2 & 2 & 4 & 16 \\
            \midrule
...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}
                L{3.6cm}C{2.8cm}C{2.8cm}C{2.8cm}@{}}
            \toprule
