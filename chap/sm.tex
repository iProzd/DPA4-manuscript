...
\begin{table}[ht]
    ...
    \begin{threeparttable}
        ...
        \begin{tablenotes}
            ...
            A disabled edge--node degree coupling denotes the scalar-scaling form that applies each
            degree-$l$ radial profile only to the degree-$l$ channels, and a disabled attention aggregation
...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}L{2.4cm}C{1.52cm}C{1.52cm}C{1.52cm}C{1.52cm}C{1.52cm}C{1.52cm}C{1.52cm}@{}}
            \toprule
            \textbf{Hyperparameter}       & \makecell{\textbf{Cumulative}\\\textbf{ablation}} & \makecell{\textbf{Compile/}\\\textbf{precision}} & \textbf{Attention}                                                           & \makecell{\textbf{Multi-focus}\\\textbf{SO(2)}} & \makecell{\textbf{Edge--node}\\\textbf{degree}\\\textbf{coupling}} & \makecell{\textbf{$\Sph$/}\\\textbf{quad.}} & \textbf{WBN} \\
            \midrule
...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}L{2.5cm}C{1.5cm}C{1.5cm}C{1.5cm}C{1.5cm}C{1.5cm}@{}}
            \toprule
            \textbf{Hyperparameter}     & \textbf{DPA4-Mini} & \textbf{DPA4-Neo}         & \textbf{DPA4-Air}         & \textbf{DPA4-Plus}        & \textbf{DPA4-Pro}        \\
            \midrule
