...
Table~\ref{tab:sm_model_config} lists the model and systems configurations of the five released DPA4 size classes, which are shared by every benchmark reported in this work; only the training schedule varies between datasets.
...
\begin{table}[p]
    \PaperTableStyle
    \caption{DPA4 model and systems configurations of the five released size classes, shared by all benchmarks.}
    \label{tab:sm_model_config}
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}
                L{4.2cm}C{1.8cm}C{1.8cm}C{1.8cm}C{1.8cm}C{1.8cm}@{}} \toprule \textbf{Hyperparameter} & \textbf{DPA4-Mini} & \textbf{DPA4-Neo} & \textbf{DPA4-Air} & \textbf{DPA4-Plus} & \textbf{DPA4-Pro} \\ \midrule Feature dim.
            & 32                 & 64                 & 64                 & 64                 & 128                \\
            ...
            Cutoff (\AA)                 & 6                  & 6                  & 6                  & 6                  & 6                  \\
            \midrule
            Edge--node degree coupling\tnote{a}  & Degree mixing      & Degree mixing      & Degree mixing      & Degree mixing      & Degree mixing      \\
            Per-channel coupling             & True               & True               & True               & True               & True               \\
            Coupling rank              & 1                  & 1                  & 1                  & 2                  & 2                  \\
            \midrule
            Attn. heads                  & 1                  & 1                  & 1                  & 1                  & 1                  \\
            Attn. value/output proj. & False              & False              & False              & False              & False              \\
            Pre mixing                   & False              & False              & False              & False              & False              \\
...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}
                L{3.6cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}@{}} \toprule \textbf{Hyperparameter} & \textbf{DPA4-Mini} & \textbf{DPA4-Neo} & \textbf{DPA4-Air} & \textbf{DPA4-Plus} & \textbf{DPA4-Pro} \\ \midrule LR scheduler & Cosine & Cosine & Cosine & Cosine & Cosine \\ Max.
            LR & $1\times10^{-3}$ & $8\times10^{-4}$ & $4\times10^{-4}$ & $3\times10^{-4}$ & $2\times10^{-4}$ \\ Min.
            LR & $1\times10^{-6}$ & $1\times10^{-6}$ & $1\times10^{-6}$ & $1\times10^{-6}$ & $1\times10^{-6}$ \\ Warmup ratio & 0.003 & 0.003 & 0.003 & 0.003 & 0.003 \\ Batch size (per GPU)\tnote{a} & $\lceil 10000/N\rceil$ & $\lceil 5000/N\rceil$ & $\lceil 3900/N\rceil$ & $\lceil 2000/N\rceil$ & $\lceil 400/N\rceil$ \\ Training epochs & 7 & 7 & 6 & 5 & 5 \\ No.
            GPUs & 2 & 2 & 4 & 4 & 16 \\
            \midrule
            Loss & MAE & MAE & MAE & MAE & MAE \\
            Loss weights $(E,F,V)$ & 20, 20, 5 & 20, 20, 5 & 20, 20, 5 & 20, 20, 5 & 20, 20, 5 \\
...
\begin{table}[p]
    ...
    \begin{threeparttable}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}
                L{3.6cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}C{2.0cm}@{}} \toprule \textbf{Hyperparameter} & \textbf{DPA4-Mini} & \textbf{DPA4-Neo} & \textbf{DPA4-Air} & \textbf{DPA4-Plus} & \textbf{DPA4-Pro} \\ \midrule LR scheduler & WSD & WSD & WSD & WSD & WSD \\ Max.
            LR & $6\times10^{-4}$ & $8\times10^{-4}$ & $3.5\times10^{-4}$ & $3.5\times10^{-4}$ & $3\times10^{-4}$ \\ Min.
            LR & $1\times10^{-6}$ & $1\times10^{-6}$ & $1\times10^{-6}$ & $1\times10^{-6}$ & $1\times10^{-6}$ \\ Warmup ratio & 0.003 & 0.003 & 0.003 & 0.003 & 0.003 \\ Decay ratio & 0.65 & 0.65 & 0.65 & 0.65 & 0.65 \\ Decay type & Cosine & Cosine & Cosine & Cosine & Cosine \\ Batch size (per GPU)\tnote{a} & $\lceil 20000/N\rceil$ & $\lceil 6000/N\rceil$ & $\lceil 4000/N\rceil$ & $\lceil 2000/N\rceil$ & $\lceil 800/N\rceil$ \\ Training epochs & 18 & 16 & 14 & 12 & 10 \\ No.
            GPUs & 4 & 8 & 16 & 24 & 32 \\
            \midrule
            Loss & MAE & MAE & MAE & MAE & MAE \\
