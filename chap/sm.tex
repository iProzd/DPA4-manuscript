...
This ablation tests the low-rank edge--node SO(2)-equivariant degree coupling (A1), namely how edge-side angular information conditions the node-side SO(2) message in the local frame (Table~\ref{tab:dpa4_radial_degree_ablation}).
