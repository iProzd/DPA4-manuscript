...
\begin{table}[p]
    \PaperTableStyle
    \caption{
        Equivariance of the $m$-truncated spherical-grid nonlinearity under random local
        $z$-axis rotations.
        These cases test the reduced local layout used in the EMFA SO(2) convolution.
